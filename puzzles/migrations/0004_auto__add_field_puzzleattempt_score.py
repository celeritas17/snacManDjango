...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PuzzleAttempt.score'
        db.add_column(u'puzzles_puzzleattempt', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PuzzleAttempt.score'
        db.delete_column(u'puzzles_puzzleattempt', 'score')
    ...
    models = {
        ...
        u'puzzles.puzzleattempt': {
            ...
            'attempt_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
